<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yonghu','办理会员') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huiyuanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'办理会员':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','办理会员') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huiyuanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'办理会员':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','办理会员') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huiyuanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'办理会员':'' }}</el-button>
    ...
    <huiyuanxinxi-cross-add-or-update v-if="huiyuanxinxiCrossAddOrUpdateFlag" :parent="this" ref="huiyuanxinxiCrossaddOrUpdate"></huiyuanxinxi-cross-add-or-update>
...
import huiyuanxinxiCrossAddOrUpdate from "../huiyuanxinxi/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      huiyuanxinxiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    huiyuanxinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.huiyuanxinxiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yonghu');
      this.$nextTick(() => {
      this.$refs.huiyuanxinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
