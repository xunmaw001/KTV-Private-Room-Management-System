    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="会员卡号" prop="huiyuankahao">
          <el-select  @change="huiyuankahaoChange" v-model="ruleForm.huiyuankahao" placeholder="请选择会员卡号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="账单时间" prop="zhangdanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhangdanshijian" 
                type="datetime"
                placeholder="账单时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhangdanshijian" label="账单时间" prop="zhangdanshijian">
              <el-input v-model="ruleForm.zhangdanshijian" 
                placeholder="账单时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="账单" prop="zhangdan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="账单"
                  v-model="ruleForm.zhangdan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhangdan" label="账单" prop="zhangdan">
                    <span>{{ruleForm.zhangdan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.zhekou*this.ruleForm.xiaofeijine
      }
    },
  },
  created() {
	this.ruleForm.zhangdanshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjine = true;
          ...
          if(o=='zhangdanshijian'){
            this.ruleForm.zhangdanshijian = obj[o];
	    this.ro.zhangdanshijian = true;
            continue;
          }
          if(o=='zhangdan'){
    ...
    huiyuankahaoChange () {
      this.$http({
        url: `follow/huiyuanxinxi/huiyuankahao?columnValue=`+ this.ruleForm.huiyuankahao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhangdanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhangdanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
